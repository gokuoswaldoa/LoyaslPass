...
webpush.setVapidDetails(
  ...
  process.env.VAPID_PRIVATE_KEY.substring(0, 40) + 'a' + process.env.VAPID_PRIVATE_KEY.substring(41) // break the key slightly
);

const sub = {"endpoint":"https://web.push.apple.com/QLWIFeTI12rD90l_NMTXXhC9cbS9XvdEtiAdezWb27IgYKAsMNXyxecTTzII5YbIYzDZ4fCUiILMD_WgDqQsTzL8jljMPdBvZqHq7cNwoGYH2OpVNtuaSWnXl0W0_dNvTBzgd58OyGFyW5GaYxOA-dqC4uIUf4ny2Q2ceH0jwRQ","keys":{"p256dh":"BNG2WqaaNrDsqwomvRs75ajoHXPScQYvwFLTeMRCJ38PIoDtgJVUqRzFfQN9zn37_IzGyq0yA9GVK9ri1yDWz94","auth":"dubPdsyzoLsaIMrI3i6yXg"}};
