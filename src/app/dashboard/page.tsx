      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-10">
        <div>
          ...
          <p className="text-slate-600 dark:text-slate-400 mt-2 font-medium text-lg">
            ...
            <button onClick={() => window.dispatchEvent(new CustomEvent("openTutorial", { detail: { title: "Instala tu Dashboard", subtitle: "Agrega tu panel a la pantalla de inicio para administrar todo rápidamente como una app.", blocking: false, storageKey: "dashboardTutorialSeen", variant: "dashboard" } }))} className="text-emerald-600 dark:text-emerald-400 text-sm font-bold underline mt-2 hover:opacity-80 transition-opacity">¿No sabes cómo instalar la app? Ver tutorial</button>
        </div>
